...
ChatLogic::ChatLogic()
{
/*Task 5: constructor code no longer needed
...
ChatLogic::~ChatLogic()
{
    /*Task 5: destructor code no longer neede
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            // Task 3 : change to unique pointer
                            // Task 4
                            ...
                            // create new edge
                            //Task 4: implementation of unique pointer for GraphEdge
                            ...
                            //Task 4: outgoing nodes exclusive, incomming as reference
    ...
    /*Task 5: localinstance of Chatbot
